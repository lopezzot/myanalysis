...
print "bg entries first file: "+str(BgnumberOfEntries)
...
global xsec_scanalp240_100_eta10
global xsec_3abg240_eta10
global luminosity
...
xsec_scanalp240_100_eta10 = 1.16047 #ab #from lorenzo/alp/lorenzo/xsectocyy.py
xsec_3abg240_eta10 = 0.6585e06 #ab #from polesell/work/alpbg/fcc3a/Events/3abf_90_1
luminosity = 5.0 #ab^-1
...
def funcs(cutDR, cutEpho):
	...
	for entry in range(0, SgnumberOfEntries):
		...
		if MALPcut < 1.5 and ((0.15<epho2epho1<0.25 and Sg_DeltaR<3.0) or (epho2epho1>0.25 and Sg_DeltaR<2.0)):
...
def funcb(cutDR, cutEpho):
	...
	for filenumber in range(0,10):
		...
		for entry in range(0, BgnumberOfEntries):
			...
			if MALPcut < 1.5 and ((0.15<epho2epho1<0.25 and Bg_DeltaR<3.0) or (epho2epho1>0.25 and Bg_DeltaR<2.0)):
...
def funcssqrtb(cutDR, cutEpho):
	...
	s1 = s*xsec_scanalp240_100_eta10*luminosity/SgnumberOfEntries
