...
global xsec_scanalp90_20_eta10
...
xsec_scanalp90_20_eta10 = 209.574#ab #from lorenzo/alp/lorenzo/xsectocyy.py
...
def funcssqrtb(cutDR, cutEpho):
	...
	s1 = s*xsec_scanalp90_20_eta10*luminosity/SgnumberOfEntries
...
def funcshisto():
	...
	histSgEphoMalp_afterMALPcut = ROOT.TH2F("Sg_afterMALPcut", "Sg_afterMALPcut", 100, 0, 1.1, 100, 0.0, 6.0)
