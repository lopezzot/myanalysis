...
global xsec_scanalp160_50_eta10
...
xsec_scanalp160_50_eta10 = 1.61624 #ab #from lorenzo/alp/lorenzo/xsectocyy.py
...
def funcs(cutDR, cutEpho):
	...
	for entry in range(0, SgnumberOfEntries):
		...
		if MALPcut < 1.5 and ((0.1<epho2epho1<0.2 and Sg_DeltaR<3.0) or (epho2epho1>0.2 and Sg_DeltaR<1.8)):
...
def funcb(cutDR, cutEpho):
	...
	for filenumber in range(0,10):
		...
		for entry in range(0, BgnumberOfEntries):
			...
			if MALPcut < 1.5 and ((0.1<epho2epho1<0.2 and Bg_DeltaR<3.0) or (epho2epho1>0.2 and Bg_DeltaR<1.8)):
...
def funcssqrtb(cutDR, cutEpho):
	...
	s1 = s*xsec_scanalp160_50_eta10*luminosity/SgnumberOfEntries
