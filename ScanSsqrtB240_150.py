...
global xsec_scanalp240_150_eta10
...
xsec_scanalp240_150_eta10 = 0.405652 #ab #from lorenzo/alp/lorenzo/xsectocyy.py
...
def funcs(cutDR, cutEpho):
	...
	for entry in range(0, SgnumberOfEntries):
		...
		if MALPcut < 1.5 and ((0.38<epho2epho1<0.45 and Sg_DeltaR<3.3) or (epho2epho1>0.45 and Sg_DeltaR<3.0)):
...
def funcb(cutDR, cutEpho):
	...
	for filenumber in range(0,10):
		...
		for entry in range(0, BgnumberOfEntries):
			...
			if MALPcut < 1.5 and ((0.38<epho2epho1<0.45 and Bg_DeltaR<3.3) or (epho2epho1>0.45 and Bg_DeltaR<3.0)):
...
def funcssqrtb(cutDR, cutEpho):
	...
	s1 = s*xsec_scanalp240_150_eta10*luminosity/SgnumberOfEntries
