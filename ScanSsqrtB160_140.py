...
global xsec_scanalp160_140_eta10
...
xsec_scanalp160_140_eta10 = 0.0254243 #ab #from lorenzo/alp/lorenzo/xsectocyy.py
...
def funcs(cutDR, cutEpho):
	...
	for entry in range(0, SgnumberOfEntries):
		...
		if MALPcut < 1.5 and epho2epho1>0.77 and Sg_DeltaR<3.1:
...
def funcb(cutDR, cutEpho):
	...
	for filenumber in range(0,10):
		...
		for entry in range(0, BgnumberOfEntries):
			...
			if MALPcut < 1.5 and epho2epho1>0.77 and Bg_DeltaR<3.1:
...
def funcssqrtb(cutDR, cutEpho):
	...
	s1 = s*xsec_scanalp160_140_eta10*luminosity/SgnumberOfEntries
