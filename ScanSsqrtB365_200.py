...
print "bg entries for first file: "+str(BgnumberOfEntries)
...
global xsec_scanalp365_200_eta10
...
xsec_scanalp365_200_eta10 = 0.532471 #ab #from lorenzo/alp/lorenzo/xsectocyy.py
...
def funcs(cutDR, cutEpho):
	...
	for entry in range(0, SgnumberOfEntries):
		...
		if MALPcut < 1.5 and ((0.3<epho2epho1<0.4 and Sg_DeltaR<3) or (epho2epho1>0.4 and Sg_DeltaR<2.5)):
...
def funcb(cutDR, cutEpho):
	...
	for filenumber in range(0,10):
		...
		for entry in range(0, BgnumberOfEntries):
			...
			if MALPcut < 1.5 and ((0.3<epho2epho1<0.4 and Bg_DeltaR<3.0) or (epho2epho1>0.4 and Bg_DeltaR<2.5)):
...
def funcssqrtb(cutDR, cutEpho):
	...
	s1 = s*xsec_scanalp365_200_eta10*luminosity/SgnumberOfEntries
	b1 = b*xsec_3abg365_eta10 * luminosity/(BgnumberOfEntries*10)
...
def funcshisto():
	...
	histSgMALPcut = ROOT.TH1F("Sg_MALPcut", "Sg", 100, 0., 300.)
