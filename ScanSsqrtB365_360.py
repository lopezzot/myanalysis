...
global xsec_scanalp365_360_eta10
...
xsec_scanalp365_360_eta10 = 0.0000262677 #ab #from lorenzo/alp/lorenzo/xsectocyy.py
...
def funcs(cutDR, cutEpho):
	...
	for entry in range(0, SgnumberOfEntries):
		...
		if MALPcut < 1.5 and Sg_DeltaR < 3.4 and epho2epho1>0.96:
...
def funcb(cutDR, cutEpho):
	...
	for filenumber in range(0,10):
		...
		for entry in range(0, BgnumberOfEntries):
			...
			if MALPcut < 1.5 and Bg_DeltaR < 3.4 and epho2epho1>0.96:
...
def funcssqrtb(cutDR, cutEpho):
	...
	s1 = s*xsec_scanalp365_360_eta10*luminosity/SgnumberOfEntries
