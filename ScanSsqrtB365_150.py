...
global xsec_scanalp365_150_eta10
...
xsec_scanalp365_150_eta10 = 1.0114 #ab #from lorenzo/alp/lorenzo/xsectocyy.py
...
def funcs(cutDR, cutEpho):
	...
	for entry in range(0, SgnumberOfEntries):
		...
		if MALPcut < 1.5 and ((0.2<epho2epho1<0.4 and Sg_DeltaR < 2.0) or (epho2epho1>0.4 and Sg_DeltaR<1.9)):
...
def funcb(cutDR, cutEpho):
	...
	for filenumber in range(0,10):
		...
		for entry in range(0, BgnumberOfEntries):
			...
			if MALPcut < 1.5 and ((0.2<epho2epho1<0.4 and Bg_DeltaR < 2.0) or (epho2epho1>0.4 and Bg_DeltaR<1.9)):
