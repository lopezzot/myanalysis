...
# Book histograms
histPhotonEnergy = ROOT.TH1F("E_photon", "Energy [GeV]", 150, 0.0, 200.0)
histMuonMass = ROOT.TH1F("Muon_Mass", "Energy [GeV]", 150, 0.0, 200.0)
...
for entry in range(0, numberOfEntries):
	...
	# If event contains 1 photon
	if branchPhoton.GetEntries() == 1:

		photon = branchPhoton.At(0)
		
		Etot = photon.P4()
		histPhotonEnergy.Fill(Etot.E())
