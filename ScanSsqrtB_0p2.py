...
global xsec_scanalp90_0p2_eta10
...
xsec_scanalp90_0p2_eta10 = 242.6287 #ab #from lorenzo/alp/lorenzo/xsectocyy.py
...
def funcs(cutDR, cutEpho):
	...
	for entry in range(0, SgnumberOfEntries):
		...
		sigmaalp = (sigmaalp**2.+(0.5*MALP)**2.)**0.5
		...
		if MALPcut < 1.5 and epho2epho1>0.2 and Sg_DeltaR<0.06:
...
def funcb(cutDR, cutEpho):
	...
	for filenumber in range(0,1000):
		...
		for entry in range(0, BgnumberOfEntries):
			...
			if MALPcut < 1.5 and epho2epho1>0.2 and Bg_DeltaR<0.06:
...
def funcssqrtb(cutDR, cutEpho):
	...
	s1 = s*xsec_scanalp90_0p2_eta10*luminosity/SgnumberOfEntries
