...
global xsec_scanalp90_50_eta10
...
xsec_scanalp90_50_eta10 = 83.94495 #ab #from lorenzo/alp/lorenzo/xsectocyy.py
...
def funcs(cutDR, cutEpho):
	...
	for entry in range(0, SgnumberOfEntries):
		...
		if MALPcut < 1.5 and Sg_DeltaR < 2.7 and epho2epho1>0.3:
...
def funcb(cutDR, cutEpho):
	...
	for filenumber in range(0,1000):
		...
		for entry in range(0, BgnumberOfEntries):
			...
			if MALPcut < 1.5 and Bg_DeltaR < 2.7 and epho2epho1 > 0.3:
...
def funcssqrtb(cutDR, cutEpho):
	...
	s1 = s*xsec_scanalp90_50_eta10*luminosity/SgnumberOfEntries
