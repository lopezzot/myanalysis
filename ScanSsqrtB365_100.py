...
global xsec_scanalp365_100_eta10
...
xsec_scanalp365_100_eta10 = 1.59755 #ab #from lorenzo/alp/lorenzo/xsectocyy.py
...
def funcs(cutDR, cutEpho):
	...
	for entry in range(0, SgnumberOfEntries):
		...
		if MALPcut < 1.5 and Sg_DeltaR < 1.4 and epho2epho1>0.2:
...
def funcb(cutDR, cutEpho):
	...
	for filenumber in range(0,10):
		...
		for entry in range(0, BgnumberOfEntries):
			...
			if MALPcut < 1.5 and Bg_DeltaR < 1.4 and epho2epho1>0.2:
...
def funcssqrtb(cutDR, cutEpho):
	...
	s1 = s*xsec_scanalp365_100_eta10*luminosity/SgnumberOfEntries
