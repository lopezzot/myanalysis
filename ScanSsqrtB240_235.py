...
global xsec_scanalp240_235_eta10
...
xsec_scanalp240_235_eta10 = 0.000104072 #ab #from lorenzo/alp/lorenzo/xsectocyy.py
...
def funcs(cutDR, cutEpho):
	...
	for entry in range(0, SgnumberOfEntries):
		...
		if MALPcut < 1.5 and epho2epho1>0.96 and Sg_DeltaR<3.15:
...
def funcb(cutDR, cutEpho):
	...
	for filenumber in range(0,10):
		...
		for entry in range(0, BgnumberOfEntries):
			...
			if MALPcut < 1.5 and epho2epho1>0.96 and Bg_DeltaR<3.15:
...
def funcssqrtb(cutDR, cutEpho):
	...
	s1 = s*xsec_scanalp240_235_eta10*luminosity/SgnumberOfEntries
